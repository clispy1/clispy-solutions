                ...
                <article className="prose prose-invert mx-auto">
                    ...
                    <div className="bg-black/20 p-8 rounded-lg">
                        <section>
                            <h2>Introduction</h2>
                            <p>
                                At {agencyInfo.name}, we respect your privacy
                                and are committed to protecting your personal
                                data. This Privacy Policy will inform you about
                        ...
                        <section className="mt-8">
                            ...
                            <ul>
                                <li>
                                    Identity Data: includes name, username or
                                    similar identifier
                                </li>
                                <li>
                                    Contact Data: includes email address and
                                    telephone numbers
                                </li>
                                <li>
                                    Technical Data: includes internet protocol
                                    (IP) address, browser type and version, time
                                    zone setting, browser plug-in types and
                        ...
                        <section className="mt-8">
                            ...
                            <ul>
                                ...
                                <li>
                                    To respond to your inquiries and contact
                                    requests
                                </li>
                                <li>To improve our website and services</li>
                                <li>
                                    To send you marketing communications (only
                                    with your consent)
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="mt-8">
                            ...
                            <p>
                                ...
                                unauthorized way, altered or disclosed. We limit
                                access to your personal data to those employees,
                                agents, contractors and other third parties who
